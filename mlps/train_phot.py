...
training_epochs = [10000] #[10000,10000,10000]
...
dir_case   = dir_base + "mlps/PARSEC_Gaia_{0}x{1}/".format(num_layers,size_layers)
file_mlp   = dir_case + "mlp.pkl"
file_loss  = dir_case + "loss_lr_{0}.png"
file_cmd   = dir_case + "cmd.png"
...
# df_iso = df_iso.query("age_Myr == [200]")
