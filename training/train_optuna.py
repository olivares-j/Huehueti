...
list_of_size_layers = [5,10,15,20,25,30]# Units in each hidden layer
...
dir_mlps  = dir_base + "Optuna_{0}_Mini_lrin_{1}_lrdr_{2}_bs_{3}_epochs_{4:1.0e}/".format(
